 ...
 * - fix/ENG-123
 */
export function parseIssueFromBranch(branchName) {
 ...
 */
export function getIssueFromCurrentBranch() {
 ...
 */
export function generateBranchName(identifier, title, style = 'feature') {
 ...
 */
export function createBranch(branchName, checkout = true) {
    if (checkout) {
